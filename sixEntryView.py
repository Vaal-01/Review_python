...
import main
from transitions import get_enunciado,get_entrada1,get_entrada2,get_entrada3,get_entrada4,get_entrada5,get_entrada6,process6,get_salida1
...
class sixEntryView:
    def __init__(self,window):
        ...
        self.database_frame = ImageTk.PhotoImage\
            (file='img\imgframes\sixentry_frame.png')
        ...
        self.entry5.place(x=150, y=512)

        #Entrada 6
        self.entry6 = Label(self.window, text=str(get_entrada6()), bg="white", fg="#353534",font=("yu gothic ui", 16, "bold"))
        self.entry6.place(x=355, y=512)
        ...
        self.five_entry.place(x=170,y=545,width=120)

        #6Entry
        self.six_entry = Entry(self.window, relief=FLAT,bg = "white",fg ="#6b6a69",font=("yu gothic ui semibold", 14))
        self.six_entry.place(x=375,y=545,width=120)
    ...
    def calculate(self):
        ...
        valor6 = self.six_entry.get()
        #Null validation 
        if valor1 == "" or  valor2 == "" or valor3 == "" or valor4 == "" or valor5 == "" or valor6 == "":
            messagebox.showerror("Incompleto", "Por favor, Ingresa los datos solicitados")
        else:
            process6(valor1,valor2,valor3,valor4,valor5,valor6)
