...
class oneEntryBigView:
    def __init__(self,window):
        ...
        self.database_frame = ImageTk.PhotoImage\
            (file='img\imgframes\oneentrybig_frame.png')
        ...
        self.submit_button.place(x=185,y=480)
